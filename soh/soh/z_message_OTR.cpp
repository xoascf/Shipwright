...
extern "C" void OTRMessage_Init() {
    ...
    CustomMessageManager::Instance->CreateMessage(
        ...
        CustomMessage("¡Eh! ¡Eh!&No puedes llevarte eso de aquï!&¡Hablo en serio!^ÂQuieres irte?&\x1B&%gSï&No%w",
    ...
    CustomMessageManager::Instance->CreateMessage(
        ...
        CustomMessage("Lo siento, no puedo venderte estos finos especïmenes,^"
                      "estos necesitan un #propietario con experiencia#.^"
                      "Vuelve cuando tengas tus propios #Bombchus#.",
                      { QM_RED, QM_GREEN }));
}
